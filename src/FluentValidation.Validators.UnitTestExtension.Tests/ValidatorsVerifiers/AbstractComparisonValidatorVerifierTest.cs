namespace FluentValidation.Validators.UnitTestExtension.Tests.ValidatorsVerifiers
{
    ...
    public class AbstractComparisonValidatorVerifierTest
    {
        [Fact]
        public void Given_CustomValidatorType_When_ConstructingVerifier_Then_Exception()
        {
            // Act & Assert
            Assert.Throws<ComparisonNotProvidedException>(() => new AbstractComparisonValidatorVerifier<FakeComparisonValidator<object, int>, object, int>(10));
        }
        ...
        public void Given_DifferentValidatorType_When_Verifying_Then_ValidationMustFail()
        {
            ...
            var verifier = new AbstractComparisonValidatorVerifier<LessThanOrEqualValidator<object, int>, object, int>(10);
        ...
        public void Given_CorrectValidatorWithDifferentValueToCompare_When_Verifying_Then_ValidationFail()
        {
            ...
            var verifier = new AbstractComparisonValidatorVerifier<LessThanValidator<object, int>, object, int>(10);
        ...
        public void Given_CorrectBuildInValidatorWithDifferentValueToCompare_When_Verifying_Then_ValidationFail()
        {
            ...
            var verifier = new AbstractComparisonValidatorVerifier<LessThanValidator<object, int>, object, int>(15);
        ...
        public void Given_CorrectValidatorWithDifferentMemberToCompare_When_Verifying_Then_ValidationFail()
        {
            ...
            var verifier = new AbstractComparisonValidatorVerifier<LessThanValidator<object, int>, object, int>(null, Comparison.LessThan, memberToCompare2);
        ...
        public void Given_CorrectValidatorWithDifferentComparison_When_Verifying_Then_ValidationFail()
        {
            // Arrange
            var comparisonValidator = new LessThanValidator<object, int>(10);
            var verifier = new AbstractComparisonValidatorVerifier<LessThanValidator<object, int>, object, int>(10, Comparison.NotEqual);
        ...
        public void Given_CorrectValidatorWithSameValueToCompareAndComparisonAndMemberToCompare_When_Verifying_Then_ValidationPass()
        {
            ...
            var verifier = new AbstractComparisonValidatorVerifier<LessThanValidator<object, int>, object, int>(null, Comparison.LessThan, memberToCompare1B);
        ...
        public void Given_BuildInValidator_When_Verifying_Then_ValidationPass<TComparisonValidator, T, TProperty>(AbstractComparisonValidatorVerifier<TComparisonValidator, T, TProperty> verifier, TComparisonValidator validator) where TComparisonValidator : AbstractComparisonValidator<T, TProperty> where TProperty : IComparable<TProperty>, IComparable
        {
            // Act & assert
        ...
        public static IEnumerable<object[]> ProvideBuildInComparisonValidatorMapping()
        {
            ...
            yield return new object[] {new AbstractComparisonValidatorVerifier<LessThanValidator<object, int>, object, int>(sameValue), new LessThanValidator<object, int>(sameValue)};
            yield return new object[] {new AbstractComparisonValidatorVerifier<LessThanOrEqualValidator<object, int>, object, int>(sameValue), new LessThanOrEqualValidator<object, int>(sameValue)};
            yield return new object[] {new AbstractComparisonValidatorVerifier<GreaterThanValidator<object, int>, object, int>(sameValue), new GreaterThanValidator<object, int>(sameValue)};
            yield return new object[] {new AbstractComparisonValidatorVerifier<GreaterThanOrEqualValidator<object, int>, object, int>(sameValue), new GreaterThanOrEqualValidator<object, int>(sameValue)};
        }
    }
}
